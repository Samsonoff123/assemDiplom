        ...
        <TabContext value={value}>
          <Box sx={{".MuiTabs-indicator": {backgroundColor: '#349E5B'}}}>
            <TabList variant="scrollable" style={{color: '#349E5B'}} onChange={(e, value)=>setValue(value)}>
              <Tab label="Тауар жасау" value={0} />
              <Tab label="Пайдаланушылар" value={1} />
          ...
          <TabPanel value={2}>
            {
              ...
              :
              <>
                <h3>Ең көп қаралған тауар</h3>
                <ProductCart {...course} />
                <Demo />
                <h3 style={{marginTop: 20}}>Ең жоғары бағаланған тауар</h3>
